...
Tags: cbnet, twitter, twitter profile, twitter tools, widget
...
This plugin is a widget to add the Twitter Tools Profile Widget (http://twitter.com/goodies/widget_profile), including all configurable options, with no need to copy/paste code.
...
* **Twitter User ID**: User Id for the Twitter user profile you wish to display. (Note: you can use *any* Twitter profile, not just your own)
...
Plugin Obsoleted. Please <a href="">install the cbnet Twitter Widget Plugin now</a> in order to continue to receive updates and support.
= 0.1.1 =
Version 0.1.1 updates the readme file.
= 0.1 =
Initial Release
